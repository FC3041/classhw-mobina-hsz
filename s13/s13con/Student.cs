...
{
    public static implementPersonFullNameComparer PersonFulltNameComparer = new implementPersonFullNameComparer();
    ...
    public static implementPersonIdComparer personIdComparer = new implementPersonIdComparer();
}

class implementPersonIdComparer : IComparer<IPerson<int>>
{
...
class implementPersonFullNameComparer : IComparer<IPerson<int>>
{
    public int Compare(IPerson<int> x, IPerson<int> y)
    {
